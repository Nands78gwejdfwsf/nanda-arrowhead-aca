...
param(
    ...
    [string]$KeyVaultName = 'NANDA-kv-aca-test38',
    [string]$AcrName = 'nandaacrarrowheadaca',
    [string]$PostgreSqlServerName = 'nanda-pg-aca-test',
    [string]$ContainerAppsEnvironmentName = 'NANDA-cae-arrowhead-aca-test11',
    [string]$StorageAccountName = 'nandastarrowheadaca',
    ...
    [string]$RecoveryServicesVaultName = 'NANDA-rsv-arrowhead-aca-files12',
